...
pubDatetime: 2025-06-03T20:13:12.000Z
draft: false
tags:
  - "mobile"
  - "ai"
...
disqusSlug: "mobile-on-device-ai-hands-on-gemma"
...
![MediaPipe sample with Gemma 3 - 1B](mediapipe-android-app-models.png)
...
![Edge Gallery App Home](gallery-app-home.png)

![Asking review license](gallery-app-hf-license.png)

![Downloading the model](gallery-app-downloading.png)

The gallery app supports three three main type of tasks - Chat, Explain Image and Summarize.
![Chat using Gemma 3n](gemma-3n-chat-google-edge-gallery.png)

![Explain Image using Gemma 3n](gemma-3n-explain-image-google-edge-gallery.png)

![Summarize using Gemma 3n](gemma-3n-summarize-google-edge-gallery.png)
...
![iOS MediaPipe sample with Gemma 3 - 1B](mediapipe-ios-app-models.png)

![iOS MediaPipe sample with Gemma 3 - 1B](mediapipe-ios-app-chat-gemma-3-1B.png)
