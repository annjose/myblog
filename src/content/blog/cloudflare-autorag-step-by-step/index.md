...
pubDatetime: 2025-05-24T00:54:13.000Z
draft: false
tags:
  - "ai"
  - "llm"
...
![R2 bucket - new](autorag-r2-bucket-empty.png)

![R2 bucket - select files](autorag-r2-bucket-select-files.png)

![R2 bucket - files uploaded](autorag-r2-bucket-files-uploaded.png)
...
![Create new AutoRAG](autorag-create-new.png)

![Select datasource](autorag-create-select-datasource.png)

![Select configurations](autorag-create-configure.png)

![Select the name for the RAG](autorag-create-select-name.png)
...
![Indexing - queued](autorag-indexing-queued.png)

![Indexing - completed](autorag-indexing-completed.png)

![Indexing - errored](autorag-indexing-errored.png)
...
![Inference - Search](autorag-inference-search.png)

![Inference - Search with AI](autorag-inference-search-with-ai-1.png)

![Inference - Search main takes](autorag-inference-search-with-ai-2.png)
